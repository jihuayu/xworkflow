...
integration::integration_test_cases!(
    ...
    case_124_security_credential_provider => "124_security_credential_provider",
    case_125_security_audit_logging => "125_security_audit_logging",
    case_126_security_gate_validation => "126_security_gate_validation",
    case_127_security_sandbox_isolation => "127_security_sandbox_isolation",
    case_128_compiler_workflow_caching => "128_compiler_workflow_caching",
    case_129_compiler_json_format => "129_compiler_json_format",
    case_130_compiler_yaml_format => "130_compiler_yaml_format",
    ...
    case_136_plugin_template_engine => "136_plugin_template_engine",
    ...
    case_139_error_fail_branch_condition => "139_error_fail_branch_condition",
    case_140_error_default_value_complex => "140_error_default_value_complex",
    case_141_error_handler_nested_subgraph => "141_error_handler_nested_subgraph",
    case_142_error_propagation_pipeline => "142_error_propagation_pipeline",
    ...
    case_145_error_handler_variable_capture => "145_error_handler_variable_capture",
    case_146_error_ifelse_condition_error => "146_error_ifelse_condition_error",
    case_147_error_aggregator_all_failed => "147_error_aggregator_all_failed",
    case_148_error_http_timeout => "148_error_http_timeout",
    case_149_error_template_undefined_var => "149_error_template_undefined_var",
    case_150_error_nested_handlers => "150_error_nested_handlers",
    case_151_error_loop_condition_fail => "151_error_loop_condition_fail",
    case_152_error_code_syntax_validation => "152_error_code_syntax_validation",
    case_153_advanced_deeply_nested_subgraph => "153_advanced_deeply_nested_subgraph",
    case_154_advanced_multiple_parallel_iter => "154_advanced_multiple_parallel_iter",
    case_155_advanced_list_ops_chain => "155_advanced_list_ops_chain",
    case_156_advanced_aggregator_transform => "156_advanced_aggregator_transform",
    case_157_advanced_complex_branching => "157_advanced_complex_branching",
    case_158_advanced_template_jinja2_complex => "158_advanced_template_jinja2_complex",
    case_159_advanced_diamond_complex_merge => "159_advanced_diamond_complex_merge",
    case_160_advanced_http_transform_pipeline => "160_advanced_http_transform_pipeline",
    case_161_advanced_loop_state_management => "161_advanced_loop_state_management",
    case_162_advanced_assigner_operations => "162_advanced_assigner_operations",
    case_163_advanced_multiple_end_nodes => "163_advanced_multiple_end_nodes",
    case_164_advanced_variable_scoping => "164_advanced_variable_scoping",
    case_165_advanced_parallel_sync => "165_advanced_parallel_sync",
    case_166_advanced_system_variables => "166_advanced_system_variables",
    case_167_advanced_conversation_history => "167_advanced_conversation_history",
    case_168_streaming_multi_llm_chain => "168_streaming_multi_llm_chain",
    case_169_streaming_event_branching => "169_streaming_event_branching",
    case_170_streaming_debug_mode => "170_streaming_debug_mode",
);
